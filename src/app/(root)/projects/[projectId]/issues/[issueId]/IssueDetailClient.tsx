  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
      ...
      <div className="space-y-3 md:space-y-4">
        {/* Status - Mobile: Compact dropdown instead of full list */}
        <div className="bg-neutral-900 rounded-lg md:rounded-xl border border-neutral-700/50 p-3 md:p-4">
          <h3 className="text-xs md:text-sm font-medium text-neutral-400 mb-2">Status</h3>
          <div className="space-y-1.5 md:space-y-2">
            {statusOptions.map((status) => (
              <form key={status.value} action={handleStatusChange}>
                ...
                >
                  <span className={`w-2.5 h-2.5 md:w-3 md:h-3 rounded-full ${status.color}`} />
        ...
        {/* Details */}
        <div className="bg-neutral-900 rounded-lg md:rounded-xl border border-neutral-700/50 p-3 md:p-4">
          <h3 className="text-xs md:text-sm font-medium text-neutral-400 mb-2">Details</h3>
          <div className="space-y-3">
            ...
            <div ref={assigneeDropdownRef} className="relative">
              ...
              >
                {issue.assignee ? (
                  ...
                  <span className="text-xs md:text-sm text-neutral-500">Unassigned</span>
                )}
                <ChevronDown
              ...
              {isAssigneeDropdownOpen && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-neutral-800 border border-neutral-700 rounded-lg shadow-xl z-10 overflow-hidden max-h-56 md:max-h-64 overflow-y-auto">
                  ...
                  >
                    ...
                    <span className="text-xs md:text-sm text-neutral-400">Unassigned</span>
                    {!issue.assignee && (
                      <Check className="w-3.5 h-3.5 md:w-4 md:h-4 text-violet-400 ml-auto" />
                    )}
                  </button>
            ...
            <div className="pt-3 border-t border-neutral-700/50">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <div className="flex-1 min-w-0">
                  <p className="text-xs md:text-sm text-white truncate">{issue.creator.name}</p>
