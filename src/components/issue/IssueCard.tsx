...
const priorityIcons: Record<string, React.ReactNode> = {
  HIGH: (
    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
      ...
      <path fillRule="evenodd" d="M5.293 12.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L10 9.414l-3.293 3.293a1 1 0 01-1.414 0z" clipRule="evenodd" />
    </svg>
  ),
  MEDIUM: (
    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
...
export function IssueCard({ issue, showProject, projectName }: IssueCardProps) {
  ...
  return (
    <Link
      ...
      className="block bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-600 transition-all group"
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {/* Priority indicator */}
        <div className={`flex items-center gap-1 px-2 py-1 rounded text-xs font-medium ${priorityColors[issue.priority]}`}>
